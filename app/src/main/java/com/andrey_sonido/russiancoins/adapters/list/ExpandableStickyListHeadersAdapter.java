package com.andrey_sonido.russiancoins.adapters.list;
 ...
 */
 class ExpandableStickyListHeadersAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    DistinctMultiHashMap<String,View> mHeaderIdToViewMap = new DistinctMultiHashMap<String, View>();
    List<String> mCollapseHeaderIds = new ArrayList<String>();
